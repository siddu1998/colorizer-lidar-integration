...
df_blue_retro_selected=pd.read_csv('blue_retro_points.csv')
df_green_retro_selected=pd.read_csv('green_retro_points.csv')
df_yellow_retro_selected=pd.read_csv('yellow_retro_points.csv')
